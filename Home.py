# theme.py — PA Planning Studio v5.8
# Sidebar color via config.toml (secondaryBackgroundColor = #7A2020)
# Streamlit auto-inverts nav text to white on dark bg — no sidebar CSS needed
...
/* Nav link shape only — NO color (config.toml handles that) */
[data-testid="stSidebarNav"] a {
    border-radius:8px !important; padding:8px 14px !important;
    margin-bottom:2px !important; font-size:14px !important;
...
/* File uploader — white, NOT red */
div[data-testid="stFileUploader"] { background:#ffffff !important; border:1.5px dashed #c8c9aa !important; border-radius:12px !important; }
div[data-testid="stFileUploader"]:hover { border-color:var(--red) !important; }
div[data-testid="stFileUploaderDropzone"] { background:#ffffff !important; }
