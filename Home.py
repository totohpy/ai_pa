...
.fcard-main::before { content:''; position:absolute; top:0; left:0; right:0; height:4px; background:linear-gradient(90deg,#7A2020,#c0392b); transform:scaleX(0); transform-origin:left; transition:transform 0.22s ease; }
a.fcard-link:hover .fcard-main { box-shadow:0 12px 40px rgba(122,32,32,0.16); transform:translateY(-6px); border-color:#b8a0a0; }
...
with u1:
    ...
    <a class="fcard-link" href="แปลงภาพเป็นข้อความ_(OCR)" target="_self">
      <div class="fcard-util">
        ...
        <div class="fcard-util-desc">ดึงข้อความจากเอกสารภาษาไทย–อังกฤษด้วย Typhoon OCR AI รองรับภาพถ่ายและ PDF</div>
      </div>
    </a>
    """, unsafe_allow_html=True)
...
with u3:
    ...
    <a class="fcard-link" href="Audit_Dashboard" target="_self">
      <div class="fcard-util">
        ...
        <div class="fcard-util-desc">อัปโหลดข้อมูล สร้าง Dashboard อัตโนมัติด้วย AI หรือเลือก Template สำเร็จรูป และกำหนดเองได้</div>
      </div>
    </a>
    """, unsafe_allow_html=True)
...
with u4:
    ...
    <a class="fcard-link" href="Analytics_Sandbox" target="_self">
      <div class="fcard-util">
        ...
        <div class="fcard-util-desc">Power BI Mode · YData Profiling · Sweetviz · PyGWalker วิเคราะห์ข้อมูลเชิงลึกครบวงจร</div>
      </div>
    </a>
    """, unsafe_allow_html=True)
