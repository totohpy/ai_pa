            ...
            with st.spinner("กำลังประมวลผล..."):
                try:
                    ...
                    resp = client.chat.completions.create(
                        ...
                        temperature=0.7, max_tokens=3072, top_p=0.9
                    )
            ...
            with st.spinner("กำลังสร้างคำแนะนำ..."):
                try:
                    ...
                    resp = client.chat.completions.create(
                        model="typhoon-v2.5-30b-a3b-instruct",
                        messages=[
                            {"role":"system","content":"คุณคือผู้เชี่ยวชาญด้านการตรวจสอบผลสัมฤทธิ์และประสิทธิภาพการดำเนินงาน (Performance Auditing)"},
